                                ...
                                <div class="login-form">
                                    ...
                                    <form class="user" @submit.prevent="productUpdate()" enctype="multipart/form-data">
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <small class="text-danger" v-if="errors.code">{{ errors.code[0] }}
                                                    </small>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="root"
                                                           placeholder="Enter Product Root" v-model="form.root">
                                                    <small class="text-danger" v-if="errors.root">{{ errors.root[0] }}
                                                    </small>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <img id="productPhoto" :src="form.image"
    ...
    export default {
        ...
        created() {
            if (!User.loggedIn()) {
                ...
                axios.get('/api/categories', this.form)
                    .then(({data}) => this.categories = data);
                axios.get('/api/suppliers', this.form)
            ...
            onFileSelected(event) {
                ...
                if (file.size > 1048770) {
                    ...
                    reader.onload = event => {
                        ...
                        $("#productPhoto").attr('src', event.target.result);
                    };
